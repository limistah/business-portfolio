    ...
    <main class="ui container-fluid pusher">
            ...
            <div class="ui top fixed  teal secondary pointing borderless menu menu-cont">
                <div class="ui container ">
                    ...
                    <div class="right menu" href="/">
                        ...
                        <a href="blog" class="ui item">
                            BLOG
                        </a>
                        <a href="foundation" class="ui item">
                            OMERIAN FOUNDATION
                        </a>
                        <a href="team" class="ui item">
                            TEAM
                        </a>
                        ...
                        <div class="action button-cont ui grid">
                            <div class="sixteen wide computer only column">
                                <div class="ui basic segment intro-text">
                                    <p>
                                        “Nigeria is one of the best-kept secrets. A lot of people are not investing because they are waiting for the right time. There is no right time.”
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="ui basic very padded segment" style="margin-bottom:0px;margin-top:0px; background:#4f9100;">
            <div class="ui stackable grid container">
                <div class="stretched three column row speech">
                    <div class="center aligned column">
                        <div class="ui segment">
                            <h2 class="ui center aligned icon header">
                                <i class="circular eye icon" style="color:#4f9100"></i>
                            </h2>
                            <h2 class="ui header">
                                Vision
                            </h2>
                            <p>
                                Omerian Consult is a business consulting firm with the vision of being the vehicle of profitable investment in Nigeria.
                            </p>
                        </div>
                    </div>
                    <div class="center aligned column">
                        <div class="ui segment">
                            ...
                            <img class="ui centered small image" src="./assets/images/target.png">
                            <h2 class="ui header" style="margin-top:calc(1.5rem - 0.14285em);">
                                Mission
                            </h2>
                            <p>
                                We provide accurate, complete and up-to-date information about the bountiful opportunities in Nigeria and also partner with both local and foreign individuals and organizations to harness them.
                            </p>
                        </div>
                    </div>
                    <div class="center aligned column">
                        <div class="ui segment">
                            <h2 class="ui center aligned icon header">
                                <i class="circular rocket icon" style="color:#4f9100"></i>
                            </h2>
                            <h2 class="ui header">
                                Objectives
                            </h2>
                            <p>
                                Unlocking the opportunities in Africa’s largest market, particularly in the non-oil sector. Promoting agriculture as the new oil.Setting a standard of ethics, integrity and professionalism in doing business in Nigeria. Fostering economic development and
                                job creation.
                            </p>
                        </div>
                    </div>
